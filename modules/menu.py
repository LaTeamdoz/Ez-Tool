    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection:
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Ez-Tool"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/LaTeamdoz/Ez-Tool.git "+system.home+"/Ez-Tool")
            if os.path.exists(system.home+"/Ez-Tool/install.aex"):
              os.system("cd "+system.home+"/Ez-Tool && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Ez-Tool"):
              ...
              os.system("git clone https://github.com/LaTeamdoz/Ez-Tool.git "+system.home+"/Ez-Tool")
            if os.path.exists(system.home+"/Ez-Tool/install.aex"):
              os.system("cd "+system.home+"/Ez-Tool && sh install.aex")
              if os.path.exists(system.bin+"/Ez-Tool") and os.path.exists(system.conf_dir+"/Ez-Tool"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall ez-tool" or cmd=="unistall Ez-Tool":
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Ez-Tool")
          os.system(system.sudo+" rm -rf "+system.bin+"/eztool")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Ez-Tool")
        else:
          os.system("rm -rf "+system.bin+"/Ez-Tool")
          os.system("rm -rf "+system.bin+"/eztool")
          os.system("rm -rf "+system.conf_dir+"/Ez-Tool")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Ez-Tool/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Ez-Tool/core/cat.json") as cat_file:
