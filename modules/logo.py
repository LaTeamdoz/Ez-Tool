...
\033[1;36m =============================================\033[1;m
\033[1;33m|          Install  Hacking Tool             |
\033[1;36m =============================================\033[00m''')
...
===============================================\033[00m''')
  ...
  def not_ins(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't install Ez-Tool.\033[1;m
...
\033[1;31m If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print ('''
\033[1;33m    [ + ] \033[1;32mEz-Tool installed successfully.
\033[1;33m    [ + ] \033[1;32mTo run Ez-Tool.
\033[1;33m    [ + ] \033[1;32mType EZ-Tool in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print ('''
\033[1;33m  [ 1 ] \033[1;32mUpdate your Ez-Tool.
\033[1;33m  [ 0 ] \033[1;32mFor Back.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mEz-Tool Updated Successfully.
...
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
  ...
  def update_error(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't Update Ez-Tool.\033[1;m
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
    self.tool_footer()
...
\033[01;33m|  00) Back                                   |
 \033[01;36m=============================================\033[00m""")
  ...
  def updating(self):
    print ("""\033[01;33m =============================================
\033[01;32m|______________ Updating Ez-Tool ______________|
 \033[01;33m=============================================\033[00m""")
...
\033[1;33m  [ 3 ] \033[1;32mUpdate Ez-Tool.
...
\033[1;33m  [ x ] \033[1;32mFor Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print ('''
\033[1;33m         [ + ] \033[1;32mThanks for using Ez-Tool
